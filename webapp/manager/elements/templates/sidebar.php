    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <?php if ($employe->isAutoriser("agence") && $employe->isAutoriser("production")) { ?>
                    <li id="agences">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <?php foreach (Home\BOUTIQUE::getAll() as $key => $item) { ?>
                                <li><a href="<?= $this->url($this->section, "production", "agences", $item->id) ?>"><?= $item->name() ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
                <?php } ?>
                ...
                <?php if ($employe->isAutoriser("agence") && $employe->isAutoriser("production")) { ?>
                    <li id="agences">
                        <a href="#"><i class="fa fa-home"></i> <span class="nav-label">Les agences</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse">
                            <?php foreach (Home\AGENCE::getAll() as $key => $item) { ?>
                                <li><a href="<?= $this->url($this->section, "production", "agences", $item->id) ?>"><?= $item->name() ?></a></li>
                            <?php } ?>
                        </ul>
                    </li>
