    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-5">
<!--                     <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-perteagence' class="btn btn-danger btn-xs dim float-right"><i class="fa fa-trash"></i> Perte du jour </button>
 -->
                    <button style="margin-top: 5%;" type="button" data-toggle=modal data-target='#modal-productionjour' class="btn btn-primary btn-sm dim float-right"><i class="fa fa-plus"></i> Production du jour </button>
            ...
            <div class="wrapper wrapper-content">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Toutes les productions et rangements</h5>
                            ...
                            <tbody>
                               <?php foreach ($encours as $key => $production) {
                                ...
                                <tr style="border-bottom: 2px solid black">
                                    ...
                                    <td>
                                        <span class="text-uppercase gras">Production du <?= datecourt($production->ladate) ?> </span><br>
                                        <span><?= $production->reference ?></span>
                                    </td>
                                    <td>
                                        <h6 class="text-uppercase text-muted gras" style="margin: 0"><?= $production->agence->name() ?></h6>
                                        <small>Enregistré <?= depuis($production->created) ?></small>
                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <?php foreach ($lots as $key => $ligne) { ?>
                                                        <td class="text-center"><?= start0($ligne->quantite) ?> <?= $ligne->produit->typeproduit->abbr ?></td>
                                                    <?php } ?>
                                                </tr>
                                            </tbody>  
                                        </table>
                                    ...
                                    <td>
                                        <a href="<?= $this->url("agence", "rapports", "coutproduction", $production->id) ?>" target="_blank" class="btn btn-white btn-sm"><i class="fa fa-file-text text-blue"></i></a>
...
<div class="modal inmodal fade" id="modal-perteagence">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="POST" class="formShamman" classname="perteagence">
