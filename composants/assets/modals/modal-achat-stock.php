...
<div class="modal inmodal fade" id="modal-achat-stock" style="z-index: 99999999">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
            <h4 class="modal-title">Nouvel achat de stock</h4>
            <small class="font-bold">Renseigner ces champs pour enregistrer le nouvel achat </small>
        </div>
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="text-center">
                                <?php foreach (Home\PRODUIT::getAll() as $key => $produit) { ?>
                                    <button class="btn btn-white dim newproduit" data-id="<?= $produit->getId() ?>" data-toggle="tooltip" title=""><?= $produit->name(); ?></button>
                                <?php }  ?>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-4 ">
                <div class="ibox"  style="background-color: #eee">
                    <div class="ibox-title" style="padding-right: 2%; padding-left: 3%; ">
                        <h5 class="text-uppercase">Finaliser l'achat </h5>
                    </div>
                    <div class="ibox-content container-fluid"  style="background-color: #fafafa">
                        ...
                        <hr/>
                        <button onclick="validerAchatStock()" class="btn btn-warning btn-block dim"><i class="fa fa-check"></i> Valider l'achat de ce stock</button>
                    </div>
                </div>
